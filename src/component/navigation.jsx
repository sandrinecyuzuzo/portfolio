...
const Navigation = () => {
    ...
    return (
        <div className="flex justify-between items-center sticky top-0 space-x-5 px-4 md:px-12 bg-[#F5F7F8]">
            <div className='flex items-center '>
                <img className='h-16 w-16 rounded-full' src={sau} alt="" />

                <div className={`absolute bg-white top-0 right-20 py-4 flex-col md:relative md:flex-row md:bg-transparent  ml-16 ${open ? "flex" : "hidden"} md:flex items-center`}>
            ...
            <div className={`hidden lg:flex items-center md:space-x-5 px-3`} >
            ...
            <svg onClick={() => { setOpen(!open); console.log(open) }} class="w-6 h-6 lg:hidden text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
